...
var accessories = products.filter(accessory => accessory.categories == "accessories");

// function filterProductsaccessories() {
//     for (var i = 0; i < accessories.length; i++) {
//         if (accessories[i].categories != "accessories") {
...
function displayaccessories() {
    // filterProductsaccessories();
    console.log(accessories);
    for (var i = 0; i < accessories.length; i++) {
        document.getElementById("mydiv").innerHTML += "<div  id='" + accessories[i].id + "_holder' class='grid-item '><img src='" + accessories[i].imgUrl + "'><h4>" + accessories[i].name + "</h4><p>" + accessories[i].rating + " <i class='fa fa-star' ></i></p><p>" + accessories[i].price + " L.E.</p><p>" + accessories[i].stock + " available</p></div>";
    }
}